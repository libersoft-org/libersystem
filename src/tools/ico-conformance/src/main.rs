...
fn main() {
	...
	validate_external(&root, "external-png", include_bytes!("../../../user/libs/image/ico/tests/data/external-png.ico"), true);
	validate_external(&root, "external-dib-alpha", include_bytes!("../../../user/libs/image/ico/tests/data/external-dib-alpha.ico"), true);
	validate_external(&root, "external-dib-zero-alpha", include_bytes!("../../../user/libs/image/ico/tests/data/external-dib-zero-alpha.ico"), true);
	validate_external(&root, "external-dib-maskless", include_bytes!("../../../user/libs/image/ico/tests/data/external-dib-maskless.ico"), false);
