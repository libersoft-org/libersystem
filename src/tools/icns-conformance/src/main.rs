...
fn main() {
	...
	validate_external_decode(&root, "external-48", include_bytes!("../../../user/libs/image/icns/tests/data/external-48.icns"));
	validate_external_decode(&root, "external-128-legacy", include_bytes!("../../../user/libs/image/icns/tests/data/external-128-legacy.icns"));
