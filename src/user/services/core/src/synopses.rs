...
pub const SYNOPSES: &[(&str, &str)] = &[
	...
	("cardhold", "cardhold CASE - hold a smart-card transaction for the smart-card gate"),
	("cardread", "cardread - read a reader with a read-only smart-card grant"),
	("cardb", "cardb - use the second fixture reader's grant"),
	("modemcheck", "modemcheck CASE - drive the modem gate against the in-guest fixture"),
	("modemhold", "modemhold CASE - hold a modem data context for the modem gate"),
	("modemswap", "modemswap CASE - replace the uplink with a modem context"),
	("modemdata", "modemdata - use a modem with a data grant alone"),
	("modemfail", "modemfail - a launch whose second modem grant cannot be minted"),
	("camcheck", "camcheck CASE - drive the camera gate against the in-guest fixture"),
	("camhold", "camhold CASE - hold a camera capture for the camera gate"),
	("camread", "camread - list cameras with inventory alone"),
	("camfail", "camfail - a launch whose second grant cannot be minted"),
	("midicheck", "midicheck CASE - drive the MIDI gate against the in-guest fixture"),
