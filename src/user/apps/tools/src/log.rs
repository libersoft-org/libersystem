...
fn query_log(logsvc: u64, timesvc: u64, boot: Option<u32>, mode: Option<JsonMode>) {
...
fn tail_log(logsvc: u64, timesvc: u64, mode: Option<JsonMode>) {
...
fn boot_epoch(timesvc: u64) -> Option<u64> {
