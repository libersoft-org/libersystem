...
const TOOL_NAMES: [&str; 42] = ["date", "cat", "write", "rm", "ls", "mkdir", "rmdir", "log", "snap", "lsdev", "config", "set", "beep", "usage", "ps", "run", "perm", "stop", "lsvol", "uname", "uptime", "dmesg", "lscpu", "free", "lsmem", "lsirq", "lspci", "lssvc", "lsblk", "lsusb", "echo", "ping", "ip", "nslookup", "tcp", "nc", "arp", "httpd", "ss", "script", "ptyecho", "readln"];
