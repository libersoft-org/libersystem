...
fn assemble_init_package(conf: &[(String, String)]) {
	...
	// several binaries.
	let sources: [(&str, PathBuf); 7] = [("system_manager", manifest.join("../user/system_manager/target/x86_64-unknown-none/debug/system_manager")), ("service_manager", manifest.join("../user/services/target/x86_64-unknown-none/debug/service_manager")), ("log_service", manifest.join("../user/services/target/x86_64-unknown-none/debug/log_service")), ("device_manager", manifest.join("../user/services/target/x86_64-unknown-none/debug/device_manager")), ("shell", manifest.join("../user/services/target/x86_64-unknown-none/debug/shell")), ("storage_service", manifest.join("../user/storage/target/x86_64-unknown-none/debug/storage_service")), ("storage_client", manifest.join("../user/storage/target/x86_64-unknown-none/debug/storage_client"))];
