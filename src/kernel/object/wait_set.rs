...
//
// That was measured rather than suspected. While bounding StorageService's replies a test
...
impl WaitSet {
	...
	// set took 434 us. That measurement is the reason this is written the way it
	// is.
	//
