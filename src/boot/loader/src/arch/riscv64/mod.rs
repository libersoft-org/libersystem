...
pub fn dma_mode_inputs(bs: *mut BootServices, root: Option<*mut uefi::FileProtocol>, system_table: *mut SystemTable) -> crate::dma_mode::Inputs {
	...
	// the firmware's identity map - the same terms the console reads it on.
