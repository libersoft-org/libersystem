...
for tool in imgview imgconv audioconv audiorec play frame_probe graphics_probe lico licoedit licoview textconf test2d-conformance-sw test2d-sw; do TOOL_WAVES[$tool]=5; done
