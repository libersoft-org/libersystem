...
The third full source pass (2026-07-03, after M0077/M0078 landed) re-verified the
...
- Concept: M0078 (the GPT probe this hardens), M0077 (`with_root`, the mechanism B3 reuses), the M0073 read-only policy (B4 closes its last gap).
