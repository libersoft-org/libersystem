...
- [ ] State the IOMMU-absent threat model honestly. Capability isolation cannot contain
  ...
  AMD-Vi and ARM SMMU are later backends to the P02M0098 contract; `virtio-iommu` is P02M0099's
  first planned provider, but P02M0098 defines the policy and clean no-IOMMU behavior now.
