...
Entry table: `count` entries, PKG_ENTRY_LEN = 72 bytes each
  0     64    name, NUL-padded (PKG_NAME_LEN); compared up to the first NUL
 64      4    blob offset from the start of the archive (u32)
 68      4    blob size in bytes (u32)
